...
st.title('Jumlah pemupukan per bulan')
st.subheader('Nama : Irsan Rasyidin  NRP : 152017012')
st.sidebar.subheader('Tugas Linear Regression')
...
x_input = st.sidebar.number_input('Masukan jumlah pupuk')
